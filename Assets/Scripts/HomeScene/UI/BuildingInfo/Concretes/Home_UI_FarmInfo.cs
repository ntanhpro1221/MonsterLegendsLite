    ...
    public class Home_UI_FarmInfo : Home_UI_BuildingInfo {
        ...
        private void LoadCollectBtn(Home_Farm farm) {
            ...
            collectBtn.SetCallback(() => {
                ...
                DataManager.Ins.UpdateData_CollectFood(farm);

                FloatingTextManager.Ins.ShowAtWorld(FloatingTextId.FoodChange, farm.TF.position).SetTextChange(food);
        ...
        private void UpdateTotalFood() {
            collectBtn.SetInfo(utils.ToStrResource(Home_SceneManager.Ins.Farms[CurTargetId].CalculateCurTotalFood()));
        }
    }
}