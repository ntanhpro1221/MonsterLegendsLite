...
namespace NGDtuanh.MonsterLegends {
    [ExecuteAlways]
    [HideMonoScript]
    public abstract class RendererExt<TRenderer> : MonoBehaviourExt where TRenderer : Renderer {
        ...
        private void CreateRenderer() {
            ...
            SetParentRdrThenUpdate();
        }

        private void SetParentRdrThenUpdate() {
        ...
        #region RENDERER PROPS IN EDITOR

        #if UNITY_EDITOR

        private UnityEditor.Editor rdrEditor;
        ...
        private void DrawRendererProps(Sirenix.OdinInspector.Editor.InspectorProperty property) {
            ...
            if (invalidTargets.Count > 0) {
                Sirenix.Utilities.Editor.SirenixEditorGUI.ErrorMessageBox(isSingle
            ...
            if (indirectTargets.Count > 0) {
                Sirenix.Utilities.Editor.SirenixEditorGUI.WarningMessageBox(isSingle
                ...
                if (GUILayout.Button(isSingle
                    ...
                    foreach (var invalidTarget in indirectTargets) invalidTarget.SetParentRdrThenUpdate();
                }
            }
            ...
            if (validTargets.Count > 0) {
                ...
                UnityEditor.Editor.CreateCachedEditor(rdrTargets, null, ref rdrEditor);
                ...
                UnityEditor.EditorGUILayout.PropertyField(rdrEditor.serializedObject.FindProperty("m_Enabled"), new GUIContent("Enabled"));
